...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/BtwPiyushHere/V2-MUSIC",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/TheVirtualChat")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/TheVirtualChat")
